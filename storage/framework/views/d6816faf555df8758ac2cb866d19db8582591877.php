<form class="form" method="POST" action="<?php echo e(url('settings/leave')); ?>" style="margin-top: 25px;padding-bottom: 10px;">
    ...
    <div class="row clearfix" style="margin-top: 20px;">
        <div class="form-group<?php echo e($errors->has('from_date') ? ' has-error' : ''); ?>">
            ...
            <div class="col-md-5">
                <input type="text" name="from_date" class="form-control datepicker" id="from_date" value="<?php echo e(old('from_date')); ?>">
            </div>
            <div class="col-md-4">
    ...
    <div class="row clearfix" style="margin-top: 20px;">
        <div class="form-group<?php echo e($errors->has('to_date') ? ' has-error' : ''); ?>">
            ...
            <div class="col-md-5">
                <input type="text" name="to_date" class="form-control datepicker" id="to_date" value="<?php echo e(old('to_date')); ?>">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-5">
                <select name="year" id="" class="form-control">
                    ...
                    <?php for($i = date('Y'); $i < 2050; $i++): ?>
                        <option value="<?php echo e($i); ?>" <?php echo e(old('year') == $i ? 'selected' : ''); ?>>
                            <?php echo e(entobn($i)); ?>
