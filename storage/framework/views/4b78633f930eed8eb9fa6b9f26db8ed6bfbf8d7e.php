	...
	<div class="col-xs-12">
		<ul class="nav nav-tabs" id="modTab" style="margin-bottom:0px;margin-left:5px;border-bottom: none;">
		    ...
		    <li <?php echo e(Request::segment(3) == 'reports' ? 'active' : ''); ?>>
		    	<a id="tabEmployee" href="<?php echo e(url('employee/' . $user->id . '/reports')); ?>">ছুটির রিপোর্ট</a>
		    </li>
		</ul>
		<div class="tab-content rendering-content">
			<div class="tab-pane active" id="tabProfile">
				...
				<div class="well" style="padding: 8px;">
					<div class="row">
						<div class="col-md-4">
							<a href="<?php echo e(url('employee/'. $user->id .'/reports')); ?>" class="btn btn-primary btn-sm">
				...
				<?php if(count($leaves = $user->applications)): ?>
