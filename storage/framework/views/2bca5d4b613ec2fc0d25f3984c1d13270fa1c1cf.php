<form class="form" method="POST" action="<?php echo e(url('apply')); ?>" style="margin-top: 25px;padding-bottom: 10px;">
    ...
    <div class="row clearfix" style="margin-top: 20px;">
        <div class="form-group<?php echo e($errors->has('authorizer_id') ? ' has-error' : ''); ?>">
            ...
            <div class="col-md-5">
                <select name="authorizer_id" id="" class="form-control select2">
                    ...
                    <?php $__currentLoopData = $authorizers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $authorizer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($authorizer->id); ?>" <?php echo e(old('authorizer_id') == $authorizer->id ? 'selected' : ''); ?>>
                            <?php echo e($authorizer->text); ?>
            ...
            <div class="col-md-4">
                <?php echo $__env->make('layouts.common.formError', ['key' => 'authorizer_id'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </div>
